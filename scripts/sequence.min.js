    ...
    Sequence = function (element, options) {
      ...
      function addEvent(element, eventName, handler) {
        if (element.addEventListener)
          return element.addEventListener(eventName, handler, !1), handler;
      ...
      function convertTimeToMs(time) {
        ...
        return (
          (fraction = time.indexOf("ms") > -1 ? 1 : 1e3),
          (convertedTime =
            "0s" == time ? 0 : parseFloat(time.replace("s", "")) * fraction)
        );
      }
      ...
      function addClass(elements, name) {
        ...
        for (
          isArray(elements) === !1 &&
            ((elementsLength = 1), (elements = [elements])),
        ...
        if (void 0 !== previousTarget)
          for (
            var topLevel = previousTarget,
              allTopLevel = parent.getElementsByTagName(topLevel.nodeName),
              i = allTopLevel.length;
            i--;
      ...
      function getHammerDirection(swipeEvents) {
        ...
        return (
          (void 0 !== swipeEvents.left || void 0 !== swipeEvents.right) &&
            (swipeDirections += 1),
          (void 0 !== swipeEvents.up || void 0 !== swipeEvents.down) &&
            (swipeDirections += 2),
          1 === swipeDirections
            ? (hammerDirection = Hammer.DIRECTION_HORIZONTAL)
            : 2 === swipeDirections
            ? (hammerDirection = Hammer.DIRECTION_VERTICAL)
            : 3 === swipeDirections && (hammerDirection = Hammer.DIRECTION_ALL),
          hammerDirection
        );
      }
      ...
      var defaults = {
        ...
        resizeThreshold = 100,
        prefixTranslations = {
          animation: { WebkitAnimation: "-webkit-", animation: "" },
        },
        ...
        (Array.prototype.indexOf = function (searchElement, fromIndex) {
          ...
          for (
            fromIndex = +fromIndex || 0,
              ...
              0 > fromIndex &&
                ((fromIndex += length), 0 > fromIndex && (fromIndex = 0));
            length > fromIndex;
            fromIndex++
          )
      ...
      return (
          ...
          getElements: function (type, option) {
            ...
            for (
              elements = document.querySelectorAll(
                option === !0 ? "." + this.defaultElements[type] : option
              ),
                elementsLength = elements.length,
                i = 0;
              elementsLength > i;
              ...
              (element = elements[i]),
                ...
                (null === rel || rel === self.$container.getAttribute("id")) &&
                  relatedElements.push(element);
            return relatedElements;
          },
          show: function (element, duration) {
            self.propertySupport.transitions === !0
        ...
        (self.autoPlay = {
          ...
          stop: function () {
            return self.options.autoPlay !== !0 || self.isAutoPlaying !== !0
              ? !1
          ...
          unpause: function () {
            return self.isAutoPlayPaused !== !0
              ? !1
              : ((self.isAutoPlayPaused = !1), this.start(!0), !0);
          },
          pause: function () {
            return self.options.autoPlay !== !0
              ? !1
              : ((self.isAutoPlayPaused = !0), this.stop(), !0);
          },
        }),
        (self.canvas = {
          init: function () {
          ...
          getSteps: function (canvas) {
            ...
            for (self.stepProperties = {}, i = 0; stepsLength > i; i++)
              (step = stepElements[i]),
                (stepId = i + 1),
                steps.push(step),
          ...
          getTransformProperties: function () {
            ...
            for (i = 0; i < self.noOfSteps; i++)
              (step = self.$steps[i]),
                (stepId = i + 1),
                (canvasTransform = { seqX: 0, seqY: 0, seqZ: 0 }),
          ...
          move: function (id, animate) {
            if (self.options.animateCanvas === !0) {
              ...
              return (
                ...
                self.isFallbackMode === !1 &&
                  ((transforms = self.stepProperties[id].canvasTransform),
                  (self.$canvas.style[
                    Modernizr.prefixed("transitionDuration")
                  ] = duration + "ms"),
        ...
        (self.animation = {
          getPhaseProperties: function (stepId) {
            var el,
              ...
              stepAnimatedChildren =
                stepElement.querySelectorAll("*[data-seq]"),
          ...
          getPhaseThreshold: function (
            ...
            return (
              isAnimating === !0 &&
                self.options.ignorePhaseThresholdWhenSkipped === !0 &&
                (ignorePhaseThreshold = !0),
              void 0 === ignorePhaseThreshold &&
                (phaseThresholdOption === !0
                  ? (phaseThresholdTime = currentPhaseDuration)
                  : phaseThresholdOption !== !1 &&
          ...
          getReversePhaseDelay: function (
            ...
            return (
              phaseThresholdOption === !0 ||
                (ignorePhaseThresholdWhenSkippedOption !== !1 &&
                  isAnimating !== !1) ||
            ...
            self.firstRun === !1 &&
              ...
              animation.domDelay(function () {
                (currentPhaseProperties = animation.startAnimateOut(
                  ...
                  (currentPhaseTotal =
                    currentPhaseProperties.watchedTimings.maxTotal),
            ...
            addClass(nextStepElement, "seq-out"),
              animation.domDelay(function () {
                (currentPhaseProperties = animation.getPhaseProperties(
                  ...
                  (nextPhaseProperties = animation.getPhaseProperties(
                    id,
                    "next"
                  )),
                  (phaseThresholdTime = animation.getPhaseThreshold(
          ...
          startAnimateIn: function (
            ...
            (self.prevStepId = self.currentStepId),
              ...
              self.firstRun === !1 || self.options.startingStepAnimatesIn === !0
                ? ((self.stepProperties[id].isActive = !0),
                  ...
                  (self.phaseThresholdTimer = setTimeout(function () {
                    addClass(nextStepElement, "seq-in"),
                      removeClass(nextStepElement, "seq-out"),
                      void 0 === nextPhaseTotal &&
                        ((nextPhaseProperties =
                          self.animation.getPhaseProperties(id, "next")),
                        (nextPhaseTotal =
                          nextPhaseProperties.watchedTimings.maxTotal)),
          ...
          reverseTimingFunction: function (timingFunction) {
            ...
            for (
              timingFunction.indexOf("cubic-bezier") < 0 &&
          ...
          getDirection: function (
            ...
            var direction = 1;
            return (direction =
              void 0 !== definedDirection
                ? definedDirection
                : reverseWhenNavigatingBackwardsOption === !0 ||
                  isFallbackMode === !0
                ? cycleOption === !0 && 1 === id && currentStepId === noOfSteps
                  ? 1
                  : currentStepId > id
                  ? -1
                  : 1
          ...
          getPropertySupport: function () {
            var transitions = !1,
              animations = !1;
            return (
              Modernizr.csstransitions === !0 && (transitions = !0),
              ...
              var start = new Date().getTime(),
                timer = setInterval(function () {
                  ...
                  (element.style[style] = from + step * (to - from) + unit),
                    1 === step &&
                      (void 0 !== callback && callback(), clearInterval(timer));
                }, 25);
          ...
          moveCanvas: function (
            ...
            if (animate === !0) {
              var currentFrom = 0,
                ...
                nextFrom = 100,
                nextTo = 0;
              -1 === direction && ((currentTo = 100), (nextFrom = -100)),
                this.animate(
                  currentStepElement,
                  "left",
                  "%",
          ...
          update: function () {
            if (void 0 !== self.$pagination.elements) {
              ...
              if (void 0 !== self.$pagination.currentLinks)
                for (
                  currentPaginationLinksLength =
                    self.$pagination.currentLinks.length,
                    i = 0;
                  currentPaginationLinksLength > i;
                  i++
                )
                  (currentPaginationLink = self.$pagination.currentLinks[i]),
                    removeClass(currentPaginationLink, "seq-current");
              for (
                self.$pagination.currentLinks = [], j = 0;
                paginationLength > j;
                j++
              )
        ...
        (self.hashTags = {
          ...
          getStepHashTags: function () {
            ...
            for (i = 0; i < self.noOfSteps; i++)
              (elementHashTag =
                self.options.hashDataAttribute === !1
                  ? self.$steps[i].id
          ...
          update: function () {
            if (
              (self.options.hashTags === !0 && self.firstRun === !1) ||
              (self.options.hashTags === !0 &&
                self.firstRun === !0 &&
                self.options.hashChangesOnFirstStep === !0)
            ) {
        ...
        (self.preload = {
          ...
          complete: function (callback) {
            self.preloaded(self),
              self.options.pausePreloader !== !0 &&
                ...
                void 0 !== this.preloadIndicatorTimer &&
                  clearInterval(this.preloadIndicatorTimer),
                (Modernizr.prefixed("animation") === !1 ||
                  Modernizr.svg === !1) &&
                ...
                for (i = 0; elementLength > i; i++)
                  for (
                    step = self.$steps[i],
                      ...
                      j = 0;
                    imagesInStepLength > j;
                    j++
                  )
                    (image = imagesInStep[j]), imagesToPreload.push(image);
              else
                for (img = [], i = 0; elementLength > i; i++)
                  (src = elements[i]),
                    (img[i] = new Image()),
                    (img[i].src = src),
          ...
          append: function () {
            return self.options.preloader === !0
              ? ((self.$preloader = document.createElement("div")),
                (self.$preloader.className = "seq-preloader"),
                (self.$preloader = [self.$preloader]),
                (self.$preloader[0].innerHTML =
                  Modernizr.prefixed("animation") !== !1 && Modernizr.svg === !0
                    ? self.preload.defaultHtml
                    : self.preload.fallbackHtml),
        ...
        (self.manageEvents = {
          ...
          init: function () {
            return (
              ...
              self.options.swipeNavigation === !0
          ...
          removeAll: function (eventList) {
            ...
            for (eventType in eventList)
              eventList.hasOwnProperty(eventType) === !0 &&
                ((theEvents = eventList[eventType]), this.remove(eventType));
            return null;
          },
          ...
          add: {
            ...
            button: function (elements, type, callback) {
              ...
              for (i = 0; elementsLength > i; i++)
                (element = elements[i]),
                  ...
                  null === element.getAttribute("data-seq-button")
                    ? (element.setAttribute("data-seq-button", !0),
              ...
              return (
                ...
                (handler = addEvent(self.$container, "mousemove", function (e) {
                  return (
                    (e = e || window.event),
                    self.isTouched === !0
                      ? void (self.isTouched = !1)
                      : void (insideElement(self.$container, e) === !0
                          ? (self.options.autoPlayPauseOnHover === !0 &&
                              self.isMouseOver === !1 &&
                              self.autoPlay.pause(),
                            (self.isMouseOver = !0))
                          : (self.options.autoPlayPauseOnHover === !0 &&
            ...
            swipeNavigation: function () {
              ...
              "function" == typeof Hammer &&
                ...
                (self.hammerTime = new Hammer(self.$container).on(
                  "swipe",
                  handler
                )),
                self.hammerTime
                  .get("swipe")
                  .set(self.options.swipeHammerOptions),
                (hammerDirection = getHammerDirection(
                  self.options.swipeEvents
                )),
                self.hammerTime
                  .get("swipe")
                  .set({ direction: hammerDirection }),
            ...
            resizeThrottle: function () {
              function throttledEvents() {
                setTimeout(function () {
                  self.canvas.getTransformProperties(),
                    self.propertySupport.transitions === !0 &&
                      self.canvas.move(self.currentStepId, !1);
                }, 500),
        ...
        (self.init = function (element) {
          ...
          (self.options = extend(defaults, options)),
            ...
            1 === self.options.autoPlayDirection
              ? ((prevStepId = id - 1),
                (self.prevStepId =
                  1 > prevStepId ? self.noOfSteps : prevStepId))
              : ((prevStepId = id + 1),
                (self.prevStepId =
                  prevStepId > self.noOfSteps ? 1 : prevStepId)),
        ...
        (self.next = function () {
          ...
          return nextStepId > self.noOfSteps && self.options.cycle === !1
            ? !1
            : (nextStepId > self.noOfSteps && (nextStepId = 1),
              self.goTo(nextStepId),
              nextStepId);
        }),
        (self.prev = function () {
          var direction,
            prevStepId = self.currentStepId - 1;
          return 1 > prevStepId && self.options.cycle === !1
            ? !1
            : (1 > prevStepId && (prevStepId = self.noOfSteps),
              self.options.reverseWhenNavigatingBackwards === !0 &&
                (direction = -1),
        ...
        (self.toggleAutoPlay = function (delay) {
          return (
            self.isAutoPlaying === !1 ? self.start(delay) : self.stop(),
            self.isAutoPlaying
          );
        }),
        (self.stop = function () {
        ...
        (self.goTo = function (
          ...
          if (
            ...
            void 0 === id ||
              ...
              (self.options.navigationSkip === !1 && self.isAnimating === !0) ||
              (self.options.navigationSkip === !0 &&
                self.navigationSkipThresholdActive === !0 &&
                void 0 === hashTagNav) ||
              (self.isFallbackMode === !0 &&
                self.isAnimating === !0 &&
                void 0 === hashTagNav) ||
              (self.options.preventReverseSkipping === !0 &&
          ...
          return (
            ...
            self.animation.moveActiveStepToTop(
              currentStepElement,
              nextStepElement
            ),
            ...
            self.isFallbackMode === !1
              ? (self.animation.resetInheritedSpeed(id),
                (self.firstRun === !1 ||
                  (self.firstRun === !0 &&
                    self.options.startingStepAnimatesIn === !0)) &&
